 ...
 * Data store class.
 *
 * <p>Basic concept of this library is to read or write any value on excel sheet as {@link String}.
 * This class is to hold this string value with it's name as map.
 *
 * <p>This class extends {@link HashMap<String, Object>} and overrides {@link #put(String, Object)}
 * to limit types of object it can hold. This class can have following classes as value of map.
 *
 * <ul>
 *   <li>{@link XlBean}
 *   <li>{@link XlList}
 ...
 * </ul>
 *
 * If you want to put any value other than the types above, use {@link #set(Object)} method which
 * converts any type of object, including Map, List or any other custom classes, to XlBean suitable
 * type.
 *
 * <p>Other methods defined in this class are utility to convert {@link Map} to other format easily.
 *
...
public class XlBean extends HashMap<String, Object> {
   ...
   *
   * <p>This method allows only the following types:
   *
   * <ul>
   *   <li>{@link XlBean}
   *   <li>{@link XlList}
   *   <li>{@link SingleValue}
   *   <li>{@link String} If the value type is other than above, then {@link
   *       IllegalArgumentException} will be thrown.
   * </ul>
   *
   * @throws IllegalArgumentException If value type doesn't match allowed type.
   */
  @Override
   ...
   *
   * <p>This method will not check type before casting so make sure that the object can be casted to
   * specified type.
   *
   * @param key
   * @return
  ...
  /**
   * Returns the object of {@code destinationClass} filled with the contents mapped from this {@link
   * XlBean} instance.
   *
  ...
  /**
   * Returns the object of {@code destinationClass} filled with the contents mapped from a {@code
   * Map} retrieved by {@code sourceKey}.
   *
   * <p>If an object retrieved by {@code sourceKey} is null or not {@code Map} instance, then it
   * returns blank instance of {@code destinationClass}.
   *
   * <p>Mapping from {@code Map} of {@code sourceKey} to instance of {@code destinationClass} is key
   * to property mapping. Refer to {@link BeanConverter} for further detail.
   *
   * @param sourceKey
  ...
  /**
   * Returns the list of {@code beanClass} instances filled with the contents mapped from beans in
   * the list which are retrieved by {@code sourceKey} from this {@code BaseMap} instance.
   *
   * @param sourceKey
   * @param beanClass
   * @return
   ...
   *
   * <p>Conversion is done by {@link BeanConverter#toMap(Object)}.
   *
   * @param obj
   */
