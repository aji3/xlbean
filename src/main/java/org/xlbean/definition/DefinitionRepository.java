...
public class DefinitionRepository {
     ...
     * {@code definitionId} already exist, then it will merge them. Otherwise,
     * it will simply add the instance to this repository.
     * </p>
     * 
     * @param definition
     */
    ...
    /**
     * Calls {@link Definition#validate()} of all the {@link Definition}
     * instances in this repository, then set the corresponding excel sheet
     * instance to each definitions.
     * 
     * @param workbook
     * 
     */
    ...
    /**
     * Add all the instances in the {@code anotherRepository} to this
     * repository.
     * 
