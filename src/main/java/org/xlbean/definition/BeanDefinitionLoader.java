 ...
 *
 * <p>Basically this class is needed only when you want to write out a bean into blank excel sheet.
 *
...
public class BeanDefinitionLoader extends DefinitionLoader<Object> {
  ...
  public DefinitionRepository load() {
    ...
    DefinitionRepository definitions =
        loadInternal(xlBeanOrXlList, new BeanDefinitionLoaderContext());
