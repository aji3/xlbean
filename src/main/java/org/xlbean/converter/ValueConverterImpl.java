...
public class ValueConverterImpl implements ValueConverter {
  ...
  private static final List<Class<?>> SUPPORT_CLASSES =
      Arrays.asList(
          int.class,
          long.class,
          char.class,
  ...
  private static final DateTimeFormatter LOCALDATE_FORMAT =
      DateTimeFormatter.ofPattern("yyyy-MM-dd");
  private static final DateTimeFormatter LOCALTIME_FORMAT =
