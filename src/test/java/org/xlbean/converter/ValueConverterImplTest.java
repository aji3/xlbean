...
public class ValueConverterImplTest {
    ...
    public void toStringTest() throws ParseException {
        ...
        assertThat(converter.toString(DATE_FORMAT.parse("2017-09-09T01:23:45.678")), is("2017-09-09T01:23:45.678"));
        assertThat(converter.toString(LocalDate.of(2017, 9, 10)), is("2017-09-10T00:00:00.000"));
        assertThat(converter.toString(LocalDateTime.of(2017, 9, 10, 1, 23, 45, 678000000)), is("2017-09-10T01:23:45.678"));
    ...
    public void toObject() throws ParseException {
        ...
        assertThat(converter.toObject("2017-09-10T01:23:45.678", Date.class), is(DATE_FORMAT.parse("2017-09-10T01:23:45.678")));
        assertThat(converter.toObject("test", LocalDate.class), is(nullValue()));
        assertThat(converter.toObject("2017-09-10T01:23:45.678", LocalDate.class), is(LocalDate.of(2017, 9, 10)));
        assertThat(converter.toObject("test", LocalDateTime.class), is(nullValue()));
        assertThat(converter.toObject("2017-09-10T01:23:45.678", LocalDateTime.class), is(LocalDateTime.of(2017, 9, 10, 1, 23, 45, 678000000)));
        assertThat(converter.toObject("test", LocalDateTime.class), is(nullValue()));
        assertThat(converter.toObject("01:23:45.678", LocalTime.class), is(LocalTime.of(1, 23, 45, 678000000)));
